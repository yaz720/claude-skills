...
└─ skills/
   ...
   └─ service-scout/         # 寻商:本地服务商甄别(驾校/家教/搬家/修车/装修…)
```
...
| [service-scout](skills/service-scout/) | 寻商 | 把「要找个本地服务商」(驾校/家教/搬家/修车/装修…)变成「选定并联系上」:行业情报先行(执照库/定价套路/高发坑)、Yelp/Google 双平台交叉解读与刷评识别、负评主题归类(区分偶发与模式)、双语询价话术 | ✅ |
